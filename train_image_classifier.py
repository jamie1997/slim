...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/home/jamie/workspace/CNN_train/slim/data/flowers/', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'model_name', 'mobilenet_v2_035', 'The name of the architecture to train.')
